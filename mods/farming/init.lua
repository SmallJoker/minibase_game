...
minetest.register_node("farming:soil_with_snow", {
	description = "Soil (snowy)",
	tiles = {"default_snow.png", "default_dirt.png", "default_dirt.png^default_snow_side.png"},
	drop = "default:dirt",
	is_ground_content = true,
	freezemelt = "farming:soil_wet",
	groups = {crumbly=3, not_in_creative_inventory=1, soil=2, cold=1},
	sounds = default.node_sound_dirt_defaults(),
})
...
for i=1,8 do
	local drop = {
		items = {
			...
			{items = {"farming:seed_cotton"},rarity=20-i*2},
			--[[{items = {"farming:seed_cotton"},rarity=28-i*3},]]
		}
	}
